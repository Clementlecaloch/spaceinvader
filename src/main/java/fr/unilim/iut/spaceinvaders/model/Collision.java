...
public class Collision {
	...
	public static boolean sprite1DansSprite2(Sprite sprite1, Sprite sprite2) {
		return (EstToucheADroite(sprite1, sprite2) || EstToucheAGauche(sprite1, sprite2));
	}

	public static boolean EstToucheAGauche(Sprite sprite1, Sprite sprite2) {
		return (leHautDuSprite1DansSprite2(sprite1, sprite2) || BasDuSprite1DansSprite2(sprite1, sprite2))
				&& gaucheDuSprite1DansSprite2(sprite1, sprite2);
	}

	public static boolean EstToucheADroite(Sprite sprite1, Sprite sprite2) {
		return (leHautDuSprite1DansSprite2(sprite1, sprite2) || BasDuSprite1DansSprite2(sprite1, sprite2))
				&& (droiteDuSprite1dansSprite2(sprite1, sprite2));
	}
	...
	public static boolean gaucheDuSprite1DansSprite2(Sprite sprite1, Sprite sprite2) {
		return (sprite2.abscisseLaPlusADroite() >= sprite1.abscisseLaPlusAGauche())
				&& (sprite2.abscisseLaPlusAGauche() < sprite1.abscisseLaPlusAGauche());
	}

	public static boolean droiteDuSprite1dansSprite2(Sprite sprite1, Sprite sprite2) {
		return (sprite2.abscisseLaPlusADroite() >= sprite1.abscisseLaPlusADroite())
	...
	public static boolean BasDuSprite1DansSprite2(Sprite sprite1, Sprite sprite2) {
		if (sprite1.ordonneeLaPlusHaute() <= sprite2.ordonneeLaPlusHaute()
